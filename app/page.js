...
export default function Index2() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-700 text-gray-900 px-4">
      <div className="w-full max-w-xl bg-gradient-to-b from-slate-200 to-gray-100 px-16 py-20 rounded-lg shadow-lg border border-gray-300">
        ...
        <div className="bg-white p-5 rounded-md shadow-md border border-gray-300">
          {loading ? (
            ...
            <>
              ...
              <div className="mt-4 py-14 px-5 bg-gray-50 rounded-md shadow-sm border border-gray-400">
                <p className="text-lg font-bold text-green-700 text-center">🔴 {matchData?.score}</p>
                <p className="text-gray-900 mt-2">
                  🏏 <span className="font-semibold mr-2">{matchData?.batsman}</span>
                ...
                <p className="text-lg text-gray-600 mt-2">📉 Run Rate: {matchData?.runRate}</p>
              </div>
